...
protected:
	...
	int process_entrust_result(CThostFtdcOrderField *pOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast);
	// int process_entrust_capital_result(CShZdMessage& msg);
	int process_entrust_deal_result(CThostFtdcTradeField *pTrade);
	// int process_order_status_result(CShZdMessage& msg);
	int process_withdraw_result(CThostFtdcOrderField *pOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast);
	int process_qryaccount_result(CThostFtdcTradingAccountField *pTradingAccount, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast);
	int process_qrydeal_result(CThostFtdcTradeField *pTrade, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast);
	int process_qryopeniner_result(CThostFtdcInvestorPositionField *pInvestorPosition, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast);
	int process_qryentrust_result(CThostFtdcOrderField *pOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast);

public:
	//simulation use this
	int process_entrust_result(const base::dictionary& dict);
	int process_entrust_deal_result(const base::dictionary& dict);
	int process_withdraw_result(const base::dictionary& dict);
	int process_qryaccount_result(const base::dictionary& dict);
	int process_qrydeal_result(const base::dictionary& dict);
	int process_qryopeniner_result(const base::dictionary& dict);
	int process_qryentrust_result(const base::dictionary& dict);
