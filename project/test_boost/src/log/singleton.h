...
{\
    return singleton_meyers<class_type>::get_instance(); \
}\
private:\
    friend class singleton_meyers<class_type>; \
    inline class_type(){}
...
public:\
    ...
    static inline class_type& get_instance()\
{\
    return singleton_once<class_type>::get_instance(); \
}\
private:\
    friend class singleton_once<class_type>; \
    inline class_type(){}
